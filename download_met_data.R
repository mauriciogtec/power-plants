...
mets2005.us <- usa.functioner(2005, list.met, dataset = 'NARR', return.usa.sub = T)
mets2015.us <- usa.functioner(2015, list.met, dataset = 'NARR', return.usa.sub = T)


#======================================================================#
## get US boundaries
#======================================================================#
usa.sub.sf <- usa.functioner(list.met = list.met, return.usa.mask = T)

#======================================================================#
## quick plot
#======================================================================#
ggplot( ) + 
  geom_sf(data = mets2015.us,
          aes(fill = temp, geometry = geometry),
          color = NA) + 
...
## PROJECTION.RASTER is a raster you want to project to
#======================================================================#
mets2005.p <- projectRaster(mets2005, PROJECTION.RASTER)
mets2006.p <- projectRaster(mets2006, PROJECTION.RASTER)
