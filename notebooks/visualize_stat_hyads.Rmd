...
```{r}
mu = array(scan("../exports/mu.csv", sep=","))
lam = array(scan("../exports/lambda.csv", sep=","), dim=c(P, R, C))
gam = array(scan("../exports/gamma.csv", sep=","), dim=c(P, R, C))
alpha = array(scan("../exports/alpha.csv", sep=","), dim=c(R, C))
```
